        ...
        <div className="mt-4 grid grid-cols-4 gap-4">
          ...
          <div className="pl-4">
            <div className="mb-2">
              ...
              <p className="border border-[#999999] rounded-md p-2">{invoiceData.patientName}</p>
            </div>
            <div>
              <p className="font-bold">Phone Number</p>
              <p className="border border-[#999999] rounded-md p-2">{invoiceData.mobile}</p>
            </div>
          </div>
          ...
          <div>
            <div className="mb-2">
              ...
              <p className="border border-[#999999] rounded-md p-2">{invoiceData.patientAddress}</p>
            </div>
            <div>
              <p className="font-bold">Doctor Name</p>
              <p className="border border-[#999999] rounded-md p-2">{invoiceData.doctorName}</p>
            </div>
          </div>
        </div>
            ...
            {invoiceData.items.map((item, index) => (
              <tr key={index} className="border-b border-black">
                <td className="border-r border-black p-1">
                  <p className="text-xs py-4">Item Name</p>
                  <p className="border border-gray-300 rounded-md p-2 mb-4">{item.item}</p>
                </td>
                <td className="border-r border-black p-1">
                  <p className="text-xs py-4">Quantity</p>
                  <p className="border border-gray-300 rounded-md p-2 mb-4">{item.quantity}</p>
                </td>
                <td className="border-r border-black p-1">
                  <p className="text-xs py-4">HSN</p>
                  <p className="border border-gray-300 rounded-md p-2 mb-4">{item.hsn}</p>
                </td>
                <td className="border-r border-black p-1">
                  <p className="text-xs py-4">Batch</p>
                  <p className="border border-gray-300 rounded-md p-2 mb-4">{item.batch}</p>
                </td>
                <td className="border-r border-black p-1">
                  <p className="text-xs py-4">Expiry</p>
                  <p className="border border-gray-300 rounded-md p-2 mb-4">{item.expiry}</p>
                </td>
                <td className="border-r border-black p-1">
                  <p className="text-xs py-4">MRP</p>
                  <p className="border border-gray-300 rounded-md p-2 mb-4">{item.mrp}</p>
                </td>
                <td className="border-r border-black p-1">
                  <p className="text-xs py-4">GST %</p>
                  <p className="border border-gray-300 rounded-md p-2 mb-4">{item.gst}</p>
                </td>
                <td className="border-r border-black p-1">
                  <p className="text-xs py-4">Discount %</p>
                  <p className="border border-gray-300 rounded-md p-2 mb-4">{item.discount}</p>
                </td>
                <td className="p-1">
                  <p className="text-xs py-4">Total</p>
                  <p className="border border-gray-300 rounded-md p-2 mb-4">{item.total}</p>
                </td>
              </tr>
            ))}
          </tbody>
