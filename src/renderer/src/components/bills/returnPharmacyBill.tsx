          ...
          <tbody>
            {invoiceData.items.map((item, index) => (
              <tr key={index} className="border-b border-black text-center">
                ...
                <td className="border-r border-black p-5">{item.item}</td>
                <td className="border-r border-black p-5">{item.quantity}</td>
                <td className="border-r border-black p-5">{item.hsn}</td>
                <td className="border-r border-black p-5">{item.batch}</td>
                <td className="border-r border-black p-5">{item.expiry}</td>
                <td className="border-r border-black p-5">{item.mrp}</td>
                <td className="border-r border-black p-5">{item.gst}</td>
                <td className="border-r border-black p-5">{item.discount}</td>
            ...
            <div className="flex flex-col items-center justify-between">
              <div className="text-center w-full my-3">
                <p className="font-bold text-sm">
                  &quot;Excess quantity purchased – returning unused items.&quot;
                </p>
              </div>
